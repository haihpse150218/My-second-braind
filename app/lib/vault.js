...
// vaultId (tuỳ chọn) được gắn vào mỗi note để graph liên môn biết note thuộc vault nào.
export async function listNotes(dir, vaultId = null) {
  ...
  for (const e of entries) {
    ...
    out.push(parseNote(slug, raw, vaultId));
  }
  return out;
}
