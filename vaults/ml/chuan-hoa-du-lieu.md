...
title: Chuẩn hóa dữ liệu (Scaling / Normalization)
vault: ml
type: concept
branch: D
order: 4
...
prev: [xu-ly-du-lieu, phan-phoi-xac-suat]
created: 2026-06-14
---
...
**📖 Lộ trình:** Nhánh D (Xử lý dữ liệu) · #4 ← cần [[xu-ly-du-lieu]] · [[phan-phoi-xac-suat]]
...
> 💻 Demo trực quan (distance domination + MinMax/Standard/Robust + outlier): `D:\MSA-FPT\Machine learning\code-practice\feature-scaling-demo.ipynb`.
