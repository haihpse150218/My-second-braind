...
next: [logistic-regression, metric-hoi-quy]
sources: [L3_LinearReg.pdf]
created: 2026-06-20
---
...
**Ngày tạo:** 2026-06-20
**Trạng thái:** 🟡 Đang học
**📖 Lộ trình:** Nhánh E (Thuật toán) · #3 ← cần [[gradient-descent]] · [[loss-function]] · → dẫn tới [[logistic-regression]] · [[metric-hoi-quy]]
