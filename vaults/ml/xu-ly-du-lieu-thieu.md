---
slug: xu-ly-du-lieu-thieu
title: Xử lý dữ liệu thiếu (Missing Data)
vault: ml
type: concept
branch: D
order: 6
...
**📖 Lộ trình:** Nhánh D (Xử lý dữ liệu) · #6 ← cần [[xu-ly-du-lieu]]
...
```
> 💻 Demo trực quan đầy đủ: `D:\MSA-FPT\Machine learning\code-practice\missing-data-missingno.ipynb` (sinh sẵn 3 cơ chế MCAR/MAR/MNAR + 4 biểu đồ missingno).
...
```
> 💻 **Template code tái dùng** (`handle_missing(df, ...)` + demo missingno 3 cơ chế): `D:\MSA-FPT\Machine learning\code-practice\missing-data-missingno.ipynb`.
