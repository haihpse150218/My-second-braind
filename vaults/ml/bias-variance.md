---
slug: bias-variance
title: Đánh đổi Bias – Variance (Bias–Variance Tradeoff)
vault: ml
type: concept
branch: A
order: 16
...
next: [regularization, feature-selection]
...
**Dùng trong:** [[../../projects/viic-image-captioning|📦 viic-image-captioning]] · [[../../projects/dsp-urbansound|📦 dsp-urbansound]]
**Tags:** #ml #overfitting #bias-variance #core
...
```
![Bias–Variance target](bias-variance-target.png)
> Tâm (+) = giá trị thật · chấm = dự đoán qua nhiều lần train. **Lệch tâm = BIAS (underfit) → Boosting · Tản rộng = VARIANCE (overfit) → Bagging.**
...
- 👉 Thực tế (Kaggle, hệ thống lớn): **hiếm khi dùng 1 model** — người ta **ensemble rất nhiều** model để cân bias–variance tốt nhất. Đây là nội dung **Buổi 7 (Ensemble)** → [[ensemble-learning]] *(L7)*.
