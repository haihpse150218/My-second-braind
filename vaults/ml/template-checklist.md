...
title: 📋 Template / Checklist — Plan xử lý dữ liệu ML
vault: ml
type: moc
status: todo
---
...
- [ ] 💻 Template code: `D:\MSA-FPT\Machine learning\code-practice\missing-data-missingno.ipynb` → `handle_missing(df, ...)`
...
- [ ] 💻 Demo: `D:\MSA-FPT\Machine learning\code-practice\feature-scaling-demo.ipynb`
...
## 📚 Nguồn
- Tổng hợp slide L1–L6 (TS. Cao Tiến Dũng) + các note atomic trong [[SECOND_BRAIN_ML]].
- Template code: `D:\MSA-FPT\Machine learning\code-practice\` (missing-data-missingno · logistic/softmax demos).
