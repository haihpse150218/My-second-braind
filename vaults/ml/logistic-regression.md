...
prev: [linear-regression, loss-function, gradient-descent]
next: [softmax, danh-gia-mo-hinh]
...
**Trạng thái:** 🟡 Đang học
**📖 Lộ trình:** Nhánh E (Thuật toán) · #4 ← cần [[linear-regression]] · [[loss-function]] · [[gradient-descent]] · → kế tiếp [[softmax]] (đa lớp) · [[danh-gia-mo-hinh]]
