---
slug: softmax
title: Softmax & Phân loại đa lớp (Multiclass Classification)
vault: ml
type: concept
branch: E
order: 5
...
prev: [logistic-regression, entropy]
next: [deep-learning]
...
**Ngày tạo:** 2026-06-21
**Trạng thái:** 🟡 Đang học
**📖 Lộ trình:** Nhánh E (Thuật toán) · #5b ← cần [[logistic-regression]] · [[entropy]] · → dùng lại trong [[deep-learning]] (lớp output)
