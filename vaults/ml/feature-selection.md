...
title: Chọn đặc trưng (Feature Selection)
vault: ml
type: concept
branch: D
order: 8
...
prev: [feature-engineering, tuong-quan, overfitting]
...
**📖 Lộ trình:** Nhánh D (Xử lý dữ liệu) · #8 ← cần [[feature-engineering]] · [[tuong-quan]] · [[overfitting]]
