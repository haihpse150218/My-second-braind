...
title: Mất cân bằng lớp (Class Imbalance)
vault: ml
type: concept
branch: D
order: 7
...
prev: [lay-mau, danh-gia-mo-hinh, logistic-regression]
sources: [L4_LogisticsReg.pdf]
created: 2026-06-21
---
...
**📖 Lộ trình:** Nhánh D (Xử lý dữ liệu) · #7 ← cần [[lay-mau]] · [[danh-gia-mo-hinh]] · liên quan [[logistic-regression]]
...
```
> 🔑 Cả 3 cách đều **kéo Recall lên** (bắt nhiều ca hiếm hơn), đổi lại **Precision giảm** (báo nhầm nhiều hơn) — không có bữa trưa miễn phí. Chọn mức đánh đổi theo chi phí FP vs FN của bài toán ([[xac-dinh-van-de]]). Chi tiết code: `D:\MSA-FPT\Machine learning\code-practice\logistic-regression-oop.ipynb` Mục 13.
...
- 💻 **Demo tự cài** (cái bẫy + 4 giải pháp, số liệu thật): `D:\MSA-FPT\Machine learning\code-practice\logistic-regression-oop.ipynb` Mục 13.
