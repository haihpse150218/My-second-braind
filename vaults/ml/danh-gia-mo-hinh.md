---
slug: danh-gia-mo-hinh
title: Đánh giá mô hình & Độ đo (Evaluation Metrics)
vault: ml
type: concept
branch: E
order: 13
...
sources: [L2_Intro_ML_DL_GenAI.pdf, L4_LogisticsReg.pdf]
created: 2026-06-14
---
...
- 💻 **Demo tự cài** (tường minh, không dùng `sklearn.metrics`): `D:\MSA-FPT\Machine learning\code-practice\logistic-regression-oop.ipynb` Mục 7–12 — confusion matrix, P/R/F1, ROC/AUC + so sánh model, PR curve.
