---
slug: dsp501-mo-hinh
title: DSP501 — Mô hình phân loại
vault: dsp
type: inbox
status: todo
...
# DSP501 — Mô hình phân loại

**Nguồn gốc:** `D:\MSA-FPT\Digital Signal Processing\workspaces\project\DSP501\model.md`
**Trạng thái:** ⬜ Chưa chưng cất
**Chủ đề cha:** [[SECOND_BRAIN_DSP]]
**Dự kiến tách:** MFCC · mel-spectrogram · CNN trên phổ
