---
slug: dsp501-dataset
title: DSP501 — Bộ dữ liệu UrbanSound8K
vault: dsp
type: inbox
status: todo
...
# DSP501 — Bộ dữ liệu UrbanSound8K

**Nguồn gốc:** `D:\MSA-FPT\Digital Signal Processing\workspaces\project\DSP501\dataset.md`
**Trạng thái:** ⬜ Chưa chưng cất
**Chủ đề cha:** [[SECOND_BRAIN_DSP]]
**Dự kiến tách:** fold là gì · vì sao không tự shuffle · rò rỉ dữ liệu
