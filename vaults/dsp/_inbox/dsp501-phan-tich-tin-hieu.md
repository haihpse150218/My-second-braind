---
slug: dsp501-phan-tich-tin-hieu
title: DSP501 — Phân tích tín hiệu
vault: dsp
type: inbox
status: todo
tags: [dsp, chua-chung-cat]
sources: [SIGNAL_ANALYSIS.md]
created: 2026-08-09
---

# DSP501 — Phân tích tín hiệu

**Nguồn gốc:** `D:\MSA-FPT\Digital Signal Processing\workspaces\project\DSP501\docs\SIGNAL_ANALYSIS.md`
**Trạng thái:** ⬜ Chưa chưng cất
**Chủ đề cha:** [[SECOND_BRAIN_DSP]]
**Dự kiến tách:** miền thời gian vs tần số · FFT · STFT · ZCR · RMS
